...
def CreateContentFeatureFiles():
    ...
    for i in range(imageCount):
        ...
        try:
            ...
            vgg19_Content_Dict[imageFile.replace(args.WIKIART_FOLDER,'')] = model_vgg19.predict(x)[0]
        except:
        ...
        if (i%args.BATCH_SIZE == 0 or i == imageCount-1):
            ...
            vgg19_Content_Features.to_csv(os.path.join(args.OUTPUT_FOLDER, "vgg19_Content_Features_Batch_" + str(i) + ".csv"))
            vgg19_Content_Dict = {}

CreateContentFeatureFiles()
fh.MergeFeatureFiles(args.OUTPUT_FOLDER, "vgg19_Content_Features")